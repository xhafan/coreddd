...
namespace CoreDdd.AspNetCore.Tests.Middlewares.TransactionScopeUnitOfWorkMiddlewares.TransactionScopeUnitOfWorkMiddlewares
{
    [TestFixture]
    public class when_invoking_for_request_which_should_not_create_transaction
    {
        private TransactionScopeUnitOfWorkMiddleware _middleware;
