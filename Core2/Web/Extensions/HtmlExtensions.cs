...
namespace Core.Web.Extensions
{
    ...
    {
        public static string BuildUrlFromExpressionWithoutParameters<TController>(this HtmlHelper htmlHelper, Expression<Action<TController>> action) where TController : Controller
        {
